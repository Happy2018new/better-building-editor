...
def main():
    ...
    ui.click('三维'); ui.click('俯视'); ui.click('放置')
    ...
    ui.check('maximize retains both model buffers', [n['id'] for n in ui.nodes('PaperDoll')] == ids)
    ...
    ui.click('材质与属性'); ui.click('逐层')
    ui.check('focused layer grid remains bounded', len(ui.nodes('Button', ui.nodes('LayerCanvas')[0])) == 144)
    ui.click('三维'); ui.click('还原视图')
