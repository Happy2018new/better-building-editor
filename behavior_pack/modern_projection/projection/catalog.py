...
SEGMENT_ICONS = {
    '场景': 'eye', '外观': 'sliders', '图层管理': 'layers',
    '显示': 'projection', '辅助': 'layers', '写入': 'cube',
    '完整': 'cube', '切面': 'cut', '单层': 'layers',
...
MATERIALS = [
    ...
    ('minecraft:white_concrete', 0, '白色混凝土', 'DFE3DF'),
    ('minecraft:oak_planks', 0, '橡木', 'BD9564'),
    ('minecraft:spruce_planks', 0, '云杉木', '795C3C'),
    ('minecraft:stone_bricks', 0, '石砖', '89918D'),
    ('minecraft:stone', 0, '石头', '8B9196'),
    ('minecraft:glass', 0, '玻璃', 'A8D6DD'),
    ('minecraft:cyan_stained_glass', 0, '青色玻璃', '54B2C7'),
    ('minecraft:oak_leaves', 0, '树叶', '709968'),
    ('minecraft:grass_block', 0, '草方块', '83AD69'),
    ('minecraft:black_concrete', 0, '黑色混凝土', '303841'),
    ('minecraft:sea_lantern', 0, '海晶灯', 'C4E6DC'),
    ('minecraft:brick_block', 0, '红砖', 'AE7062'),
    ('minecraft:sandstone', 0, '砂岩', 'D9C897'),
    ('minecraft:white_wool', 0, '白色羊毛', 'ECECE4'),
